...
public class StudentsController : ControllerBase
{
    ...
    // In production replace adminKey check with proper JWT / role-based auth.
    [HttpPost("{id}/emergency-location")]
    public IActionResult GetEmergencyLocation(int id, [FromBody] EmergencyRequest req)
    {
        const string ADMIN_KEY = "CAMPUSPULSE_ADMIN_2025"; // replace with env-var / auth in production
